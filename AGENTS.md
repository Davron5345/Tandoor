...
**Последнее обновление документации:** 2026-08-28 (инвентаризация: отступ вкладок + скрытие суммы)
...
**Избранное:** список только из звезды в шапке (сетка 2×2 с профилем / сворачиванием / темой). У подразделов (не у «Главная»/«Telegram» и не у самих групп) тоже звезда; клик делает её жёлтой (`localStorage` `warehouse-nav-favorites_v1`). В меню отдельного пункта «Избранное» нет.
