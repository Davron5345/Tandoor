...
**Последнее обновление документации:** 2026-08-28 (инвентаризация: поиск как в приходе)
...
| `/inventory` | Inventory.jsx | documents.inventory; документ по отделу; **телефон** — компактная шапка (дата/№ 34px, отдел, комментарий по кнопке), ряд «Заполнить\|Все\|Расхожд.», бар «Поиск\|Добавить», компактные карточки строк, portal Modal/FAB; desktop — таблица + поиск |
