...
**Последнее обновление документации:** 2026-08-28 (вкладки вне скролла main-content)
...
**Избранное:** список только из звезды в шапке (сетка 2×2 с профилем / сворачиванием / темой). Звезда — на вкладках подразделов (не у «Главная»/«Telegram» и не у групп в сайдбаре); ключ `localStorage` `warehouse-nav-favorites_v1`. В меню отдельного пункта «Избранное» нет.
