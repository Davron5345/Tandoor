...
**Последнее обновление документации:** 2026-07-21 (быстрое создание поставщика и товара в приходе)
...
| 2026-07-21 | Приход: кнопки `+` в модалке документа быстро создают и сразу выбирают поставщика или товар; товар автоматически привязывается к выбранному поставщику |
