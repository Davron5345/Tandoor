...
**Последнее обновление документации:** 2026-07-22 (редактирование товара из прихода)
...
| 2026-07-22 | Приход: кнопка редактирования у выбранного товара открывает ту же карточку (`ProductCreateModal` в режиме edit, вкладка «Варианты») — можно добавить варианты без ухода в справочник |
