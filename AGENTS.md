...
**Последнее обновление документации:** 2026-08-28 (инвентаризация: ровные отступы 16px на вкладках)
...
| `/inventory` | Inventory.jsx | documents.inventory; **2 вкладки:** 1) дата/№ + отделы кубиками + комментарий → «Далее»; 2) заполнить по учёту / добавить / поиск (`textMatchesSearch`) / список; создание — вкладка 1, открытие — вкладка 2; телефон — portal Modal/FAB, компактные карточки |
