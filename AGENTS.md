...
**Последнее обновление документации:** 2026-08-27 (инвентаризация: мобильное меню + карточки)
...
| `/inventory` | Inventory.jsx | documents.inventory; документ по отделу: учёт / факт / разница; заполнение по учёту; проведение из карточки; **планшет** — компактная таблица (шапка 2 колонки), **телефон** — список карточек и полноэкранная карточка документа (факт крупным полем) |
