...
**Последнее обновление документации:** 2026-07-28 (мигание шапки выписки зелёным)
...
- Список дней: кнопка **«Столбцы»** — показать/скрыть колонки (portal поверх `.card`, чтобы меню не обрезалось; `localStorage` `bank_days_visible_columns_v1`); шапка колонок при скролле — **fixed pin** (как остатки: `.bank-days-head-pin`), мягкая зелёная вспышка при закреплении; список уходит под неё
