...
**Последнее обновление документации:** 2026-07-27 (Банк: меню столбцов через portal)
...
| `/payments` | Payments.jsx | payments.view; справочник счетов («Основной»); список по датам с сальдо/дебет/кредит; выбор видимых столбцов; импорт AccReferenceReport |
