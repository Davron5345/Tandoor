...
**Последнее обновление документации:** 2026-07-27 (Банк: «Основной» + выбор столбцов)
...
- Список дней: кнопка **«Столбцы»** — показать/скрыть колонки (дата, тип, №, дебет/кредит, сальдо, операции; `localStorage` `bank_days_visible_columns_v1`)
