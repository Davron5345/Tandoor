...
**Последнее обновление документации:** 2026-08-27 (избранное сеткой 2×2 в шапке)
...
**Избранное:** звезда в шапке сайдбара (сетка 2×2 вместе с профилем / сворачиванием / темой) открывает список; у подразделов (не у «Главная»/«Telegram» и не у самих групп) тоже звезда. Клик делает её жёлтой и добавляет пункт (`localStorage` `warehouse-nav-favorites_v1`). Повторный клик снимает. Блок «Избранное» в меню дублирует список.
