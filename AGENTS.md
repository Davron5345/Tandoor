...
**Последнее обновление документации:** 2026-09-19 (мобильный рабочий стол)
...
| Маршрут | Файл | Права |
|---------|------|-------|
| `/` | Dashboard.jsx | dashboard.view; «Топ по стоимости остатка» — `stock × avg_cost` склада; **телефон (≤768px):** «Рабочий стол» — сетка «Быстрый доступ» (`MobileWorkspaceHome` + `mobileQuickLinks.js`) вместо графиков; жёлтая шапка; кнопка Telegram внизу |
