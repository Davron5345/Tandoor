...
**Последнее обновление документации:** 2026-09-02 (инвентаризация: квадратные кубики отделов)
...
| Маршрут | Файл | Права |
|---------|------|-------|
| `/` | Dashboard.jsx | dashboard.view; «Топ по стоимости остатка» — `stock × avg_cost` склада |
