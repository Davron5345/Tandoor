...
**Последнее обновление документации:** 2026-07-27 (иконки сайдбара в logo-mark)
...
**Блок аккаунта сверху (`sidebar-account` под логотипом):** филиал/Telegram/выход — иконки в синем mark как у `logo-mark`; профиль в одну строку. Плашка «Telegram не настроен» убрана.
