...
**Последнее обновление документации:** 2026-08-27 (избранное в шапке сайдбара)
...
**Избранное:** звезда рядом с «Склад» в шапке сайдбара открывает список; у подразделов (не у «Главная»/«Telegram» и не у самих групп) тоже звезда. Клик делает её жёлтой и добавляет пункт (`localStorage` `warehouse-nav-favorites_v1`). Повторный клик снимает. Блок «Избранное» в меню дублирует список.
...
| 2026-08-27 | Сайдбар: избранное в шапке (звезда рядом с «Склад»), выпадающий список страниц |
