...
**Последнее обновление документации:** 2026-08-28 (инвентаризация: заголовок в topbar с меню)
...
| `/inventory` | Inventory.jsx | documents.inventory; **телефон:** заголовок+филиал в `.main-topbar` рядом с меню; **2 вкладки:** 1) дата/№ + отделы кубиками → «Далее»; 2) заполнить/добавить/поиск/список; portal Modal/FAB |
